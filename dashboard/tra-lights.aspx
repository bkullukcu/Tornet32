<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="tra-lights.aspx.vb" Inherits="Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="headContent" Runat="Server">
    <title>ALL1N Dashboard | Trafik Lambaları</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="icerik" Runat="Server">
    <section class="content ">
        ...
        <option>Konak</option>
                                                ...
                                                <br> <p>Sokak Seçiniz</p><select class="form-control" id="sel1">
        <option>Atatürk Mahallesi</option>
        <option>Barbaros Mahallesi</option>
        <option>Birlik Mahallesi</option>
        <option>Çamkule Mahallesi</option>
      </select>
                                                </div>
                                            </form>
                                        </div>
